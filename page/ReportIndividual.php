...
$_SESSION['TechnicianSession'] = $_POST['__caseTechnician'];
...
<hr class='mb-2'>
    ...
    <select id="countries" name="__caseTechnician" style="display: inline-block;" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-400">
            ...
            <tbody>
                <?php 
                        if(isset($_POST['submit'])){
                            ...
                            $technician = $_POST['__caseTechnician'];
                            // echo $technician;   
                        
                            $start = ($page - 1) * $perpage;
                            $sql = "SELECT * from mains WHERE LOGS_TECHNICIANS = '$technician' ORDER BY LOGS_DATE ASC limit {$start} , {$perpage}";
                            $query = $db->query($sql);
