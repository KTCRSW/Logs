    ...
    <div class="w-full   items-center">
        <div class="w-full gap-2 flex justify-end max-[767px]:justify-center     ">
            <form method="POST" class="" id="">
                <a type="button" href="./InsertData.php" style="display: inline-block;" class="shadow bg-[#01cc85] focus:shadow-outline hover:bg-blue-500 focus:outline-none text-white font-bold py-2 px-8 rounded">เพิ่มรายงาน
                    <i class="fa-solid fa-plus"></i></a>
            </form>
            <form>
                <a type="button" href="../mPDF/ResultAttendance.php" name="submit" style="display: inline-block;" class="shadow bg-[#2f69fd] focus:shadow-outline hover-bg-blue-500 focus:outline-none text-white font-bold py-2 px-8 rounded" type="button">พิมพ์ <i class="fas fa-print"></i></a>
            </form>
        </div>
    </div>
                ...
                ?>
                    <tr class="bg-white border-b dark:bg-white dark:border-gray-200">
                        ...
                        <td class="px-6 py-4 text-right">
                            <button type="submit" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" data-case-number="<?php echo $row['LOGS_CASE_NUMBER']; ?>" data-case-location="<?php echo $row['LOGS_LOCATION']; ?>" data-case-date="<?php echo $row['LOGS_DATE']; ?>" data-case-technician="<?php echo $row['LOGS_TECHNICIANS']; ?>" data-case-contact="<?php echo $row['LOGS_CASE_CONTACT']; ?>" data-case-phone="<?php echo $row['LOGS_PHONE']; ?>" data-case-range="<?php echo $row['LOGS_RANGE_TIME']; ?>" class="font-bold text-blue-600 text-red-300  hover:underline" style="text-decoration:none;">
                                        ...
                                        <div class="px-6 py-6 lg:px-8">
                                            ...
                                            <form action="../App/Edit.php" method="POST" class="mb-4" id="editForm">
                                                ...
                                                <div class="md:flex md:items-center mb-6">
                                                    ...
                                                    <div class="md:w-2/3">
                                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-400" id="inline-full-name" type="text" value="<?php echo $row['LOGS_TECHNICIANS']; ?>" name="__caseNumber" required>
                                                    </div>
                                                </div>
                                                <div class="md:flex md:items-center mb-6">
                                                    <div class="md:w-1/3">
                                                    ...
                                                    <div class="md:w-2/3">
                                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-400" id="inline-password" type="text" placeholder="<?php echo $row['LOGS_CASE_NUMBER']; ?>" name="__caseLocation" required>
                                                    </div>
                                                </div>
                                                <div class="md:flex md:items-center mb-6">
                                                    <div class="md:w-1/3">
                                                ...
                                                <div class="md:flex md:items-center mb-6">
                                                    ...
                                                    <div class="md:w-2/3">
                                                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-400" id="inline-password" type="text" placeholder="" name="__caseTechnician" required>
                                                    </div>
                                                ...
                                                <div class="w-full   items-center">
                                                    <div class="w-full gap-2 flex justify-end max-[767px]:justify-center     ">
                                                        ...
                                                        <button type="submit" onclick="editForm()" class="shadow bg-[#01cc85]  focus:shadow-outline hover:bg-blue-500 focus:outline-none text-white font-bold py-2 px-8 rounded">บันทึก
                                                            <i class="fa-regular fa-floppy-disk"></i>
                                                        </button>
                                            </form>

                                            <form action="" id="removeData" method="POST" class="mb-4">
                                                <input type="text" name="__caseID" id="" value="<?= $row['LOGS_ID'] ?>" hidden>
                                                <button type="button" class="shadow bg-red-500  focus:shadow-outline hover:bg-red-400 focus:outline-none text-white font-bold py-2 px-8 rounded" type="button" id="removeSubmit">
                                                    ลบ
                                                </button>
                                            </form>
                                        </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#removeSubmit').click(function() {
            var EmptyData = false;
            $('input[type="__caseID"]').each(function() {
                if ($(this).val().trim() === "") {
                    Swal.fire({
                        icon: 'warning',
                        title: 'คำเตือน',
