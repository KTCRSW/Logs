    ...
    <form class="w-full max-w-lg" action="./App/Create.php" method="post">
        ...
        <div class="md:flex md:items-center mb-6">
            ...
            <div class="md:w-2/3">
                <select id="countries" name="__caseTechnician" class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-400">
                    ...
                    <option value="">ช่าง 1</option>
                    <option value="">ช่าง 2</option>
                    <option value="">ช่าง 3</option>
                    <option value="">ช่าง 4</option>
        ...
        <div class="w-full   items-center">
            <div class="w-full gap-2 flex justify-end max-[767px]:justify-center     ">
                <button type="submit" name="submit" class="shadow bg-[#01cc85]  focus:shadow-outline hover:bg-green-500 focus:outline-none text-white font-bold py-2 px-8 rounded" type="button">
                    บันทึก
